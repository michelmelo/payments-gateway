...
/**
 * Serviço para integração de pagamentos via XPay.
 */
class XPayService implements PaymentMethodInterface
{
    protected $payment_type;
    protected $paymentMethod = ['XPAY'];
    protected $value;
    protected $order_id;
    protected $currency;
    ...
    /**
     * Solicita o estorno (refund) de um pagamento XPay.
     *
    ...
    /**
     * Consulta o status de um pagamento XPay.
     *
    ...
    /**
     * Valida os dados de pagamento XPay.
     *
     * @param array $paymentData Dados do pagamento.
