...
/**
 * Serviço para integração de pagamentos via BLIK.
 */
class BlikService implements PaymentMethodInterface
{
    ...
    /**
     * Solicita o estorno (refund) de um pagamento BLIK.
     *
    ...
    /**
     * Consulta o status de um pagamento BLIK.
     *
    ...
    /**
     * Valida os dados de pagamento BLIK.
     *
     * @param array $paymentData Dados do pagamento.
