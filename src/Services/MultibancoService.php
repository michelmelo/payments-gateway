...
/**
 * Serviço para integração de pagamentos via Multibanco.
 */
class MultibancoService implements PaymentMethodInterface
{
    ...
    /**
     * Construtor do serviço Multibanco.
     *
    ...
    /**
     * Processa um pagamento Multibanco.
     *
    ...
    /**
     * Solicita o estorno (refund) de um pagamento Multibanco.
     *
    ...
    /**
     * Consulta o status de um pagamento Multibanco.
     *
    ...
    /**
     * Valida os dados de pagamento Multibanco.
     *
     * @param array $paymentData Dados do pagamento.
